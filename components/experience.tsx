...
export default function Experience() {
  return (
    <section id="experience" className="py-28 lg:py-36 bg-[#F5F5F7] relative overflow-hidden">
      {/* Very faint background textures — near-invisible */}
      <div
      ...
      <div className="container px-4 sm:px-6 mx-auto relative z-10">
        ...
        <div className="mb-20 text-center max-w-2xl mx-auto reveal-scale-on-scroll">
          ...
          <h2
            className="type-section font-serif text-[#1D1D1F]"
          >
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <h3 className="type-subsection text-[#1D1D1F] font-serif flex items-center gap-3 mb-10 reveal-on-scroll">
              <span className="w-6 h-[1.5px] rounded-full" style={{ backgroundColor: '#8B6914' }}></span>
            ...
            <div className="relative border-l border-[#D2D2D7] ml-3 space-y-10 pb-4">
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <Card className="border border-[#D2D2D7] bg-white hover:shadow-[0_4px_24px_rgba(0,0,0,0.07)] transition-all duration-300 shadow-none rounded-xl group">
                    <CardHeader className="pb-2 pt-5 px-6">
                      <div className="flex flex-wrap justify-between items-start gap-3">
                        <div>
                          <CardTitle
                            className="type-card-heading font-serif text-[#1D1D1F]"
                          >
                            {exp.role}
                          </CardTitle>
                          <CardDescription className="font-medium mt-1 text-sm" style={{ color: '#8B6914' }}>
                            {exp.firm}
                          </CardDescription>
                        </div>
          ...
          {/* Credentials — Education & Licensing */}
          <div className="lg:col-span-5">
            <h3 className="type-subsection text-[#1D1D1F] font-serif flex items-center gap-3 mb-10 reveal-on-scroll">
              <span className="w-6 h-[1.5px] rounded-full bg-[#D2D2D7]"></span>
              Education &amp; Licensing
            </h3>
            ...
            <div className="grid gap-3">
              {credentials.map((cred, index) => (
                ...
                >
                  <div className="p-5 rounded-xl bg-[#F5F5F7] border border-transparent hover:border-[#D2D2D7] hover:bg-white hover:shadow-[0_2px_16px_rgba(0,0,0,0.06)] transition-all duration-300">
