            ...
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="h-full p-1.5 group/card">
                  <Card className="border border-white/[0.08] bg-white/[0.05] hover:bg-white/[0.08] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 h-full relative overflow-hidden rounded-lg shadow-none">
